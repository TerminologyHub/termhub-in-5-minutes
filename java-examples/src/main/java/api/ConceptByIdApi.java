...
public class ConceptByIdApi {
  ...
  /**
   * Get subset members from concept by id
   * Gets subset members from the specified concept
   * @param idOrUriLabel Project id or uriLabel, e.g. \&quot;sandbox\&quot; (required)
   * @param conceptId concept id, e.g. \&quot;uuid\&quot; (required)
   ...
   * @http.response.details
     <table summary="Response Details" border="1">
       ...
       <tr><td> 401 </td><td> Unauthorized </td><td>  -  </td></tr>
       <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
       <tr><td> 200 </td><td> Subset members from the concept matching specified id in specified project </td><td>  -  </td></tr>
       <tr><td> 500 </td><td> Internal server error </td><td>  -  </td></tr>
     </table>
   */
  public List<SubsetMember> getConceptMembers1(String idOrUriLabel, String conceptId) throws ApiException {
    return getConceptMembers1WithHttpInfo(idOrUriLabel, conceptId).getData();
  }
   ...
   */
  public ApiResponse<List<SubsetMember>> getConceptMembers1WithHttpInfo(String idOrUriLabel, String conceptId) throws ApiException {
    // Check required parameters
    if (idOrUriLabel == null) {
      throw new ApiException(400, "Missing the required parameter 'idOrUriLabel' when calling getConceptMembers1");
    }
    if (conceptId == null) {
      throw new ApiException(400, "Missing the required parameter 'conceptId' when calling getConceptMembers1");
    }

    // Path parameters
    String localVarPath = "/project/{idOrUriLabel}/concept/{conceptId}/members"
            .replaceAll("\\{idOrUriLabel}", apiClient.escapeString(idOrUriLabel))
            .replaceAll("\\{conceptId}", apiClient.escapeString(conceptId));
    ...
    return apiClient.invokeAPI("ConceptByIdApi.getConceptMembers1", localVarPath, "GET", new ArrayList<>(), null,
                               new LinkedHashMap<>(), new LinkedHashMap<>(), new LinkedHashMap<>(), localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
}
