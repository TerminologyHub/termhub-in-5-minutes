...
class ResultListMapset(BaseModel):
    ...
    items: Optional[List[Mapset]] = Field(default=None, description="items of the result list")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [Mapset.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
