...
class MapsetApi:
    ...
    def export_mapset_mappings(
        ...
        _param = self._export_mapset_mappings_serialize(
            id=id,
            query=query,
            active=active,
    ...
    @validate_call
    def export_mapset_mappings_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Mapset id, e.g. \"uuid\"")],
        query: Annotated[Optional[StrictStr], Field(description="Search text")] = None,
        active: Annotated[Optional[StrictBool], Field(description="<code>true</code> for active mappings only, <code>false</code> for inactive mappings only, <code>null</code> for both")] = None,
    ...
    @validate_call
    def export_mapset_mappings_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Mapset id, e.g. \"uuid\"")],
        query: Annotated[Optional[StrictStr], Field(description="Search text")] = None,
        active: Annotated[Optional[StrictBool], Field(description="<code>true</code> for active mappings only, <code>false</code> for inactive mappings only, <code>null</code> for both")] = None,
    ...
    def _export_mapset_mappings_serialize(
        self,
        id,
        query,
        active,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/mapset/{id}/mapping/export',
    ...
    @validate_call
    def export_project_mapset_without_preload_content(
        self,
        id_or_uri_label: Annotated[StrictStr, Field(description="Project id or uriLabel, e.g. \"sandbox\"")],
        mapset: Annotated[StrictStr, Field(description="Mapset id or abbreviation e.g. \"uuid1\" or \"CVX-NDC\".")],
        format: Annotated[StrictStr, Field(description="Requested download format, e.g. \"native\", \"r4\", \"r5\", \"r4-json-only\", \"r5-json-only\"")],
    ...
    def _export_project_mapset_serialize(
        self,
        id_or_uri_label,
        mapset,
        format,
    ...
    @validate_call
    def export_project_mapset_mappings(
        self,
        id_or_uri_label: Annotated[StrictStr, Field(description="Project id or uriLabel")],
        mapset: Annotated[StrictStr, Field(description="Comma-separated list of mapset ids or abbreviations (or null for all mapsets). e.g. \"uuid1,uuid2\", \"SNOMEDCT_US-ICD10CM,CVX-NDC\".")],
        query: Annotated[Optional[StrictStr], Field(description="Search text")] = None,
        active: Annotated[Optional[StrictBool], Field(description="<code>true</code> for active mappings only, <code>false</code> for inactive mappings only, <code>null</code> for both")] = None,
        _request_timeout: Union[
            None,
        ...
        _param = self._export_project_mapset_mappings_serialize(
            id_or_uri_label=id_or_uri_label,
            mapset=mapset,
            query=query,
            active=active,
    ...
    @validate_call
    def export_project_mapset_mappings_with_http_info(
        self,
        id_or_uri_label: Annotated[StrictStr, Field(description="Project id or uriLabel")],
        mapset: Annotated[StrictStr, Field(description="Comma-separated list of mapset ids or abbreviations (or null for all mapsets). e.g. \"uuid1,uuid2\", \"SNOMEDCT_US-ICD10CM,CVX-NDC\".")],
        query: Annotated[Optional[StrictStr], Field(description="Search text")] = None,
    ...
    @validate_call
    def export_project_mapset_mappings_without_preload_content(
        self,
        id_or_uri_label: Annotated[StrictStr, Field(description="Project id or uriLabel")],
        mapset: Annotated[StrictStr, Field(description="Comma-separated list of mapset ids or abbreviations (or null for all mapsets). e.g. \"uuid1,uuid2\", \"SNOMEDCT_US-ICD10CM,CVX-NDC\".")],
        query: Annotated[Optional[StrictStr], Field(description="Search text")] = None,
    ...
    def _export_project_mapset_mappings_serialize(
        self,
        id_or_uri_label,
        mapset,
        query,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/project/{idOrUriLabel}/mapset/{mapset}/mapping/export',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def find_mapset_mappings(
        self,
        id: Annotated[StrictStr, Field(description="Mapset id, e.g. \"uuid1\".")],
        query: Annotated[Optional[StrictStr], Field(description="Search text")] = None,
    ...
    def _find_mapset_mappings_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/mapset/{id}/mapping',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def find_project_mappings(
        self,
        id_or_uri_label: Annotated[StrictStr, Field(description="Project id or uriLabel")],
        mapset: Annotated[Optional[StrictStr], Field(description="Comma-separated list of mapset ids or abbreviations (or null for all mapsets). e.g. \"uuid1,uuid2\", \"SNOMEDCT_US-ICD10CM,CVX-NDC\".")] = None,
        query: Annotated[Optional[StrictStr], Field(description="Search text")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Start index for search results")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="Limit of results to return (hard limit of 1000 regardless of value)")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Comma-separated list of fields to sort on")] = None,
        ...
        :param id_or_uri_label: Project id or uriLabel (required)
        :type id_or_uri_label: str
        :param mapset: Comma-separated list of mapset ids or abbreviations (or null for all mapsets). e.g. \"uuid1,uuid2\", \"SNOMEDCT_US-ICD10CM,CVX-NDC\".
        :type mapset: str
        :param query: Search text
        :type query: str
        :param offset: Start index for search results
        ...
        _param = self._find_project_mappings_serialize(
            id_or_uri_label=id_or_uri_label,
            mapset=mapset,
            query=query,
            offset=offset,
    ...
    @validate_call
    def find_project_mappings_with_http_info(
        self,
        id_or_uri_label: Annotated[StrictStr, Field(description="Project id or uriLabel")],
        mapset: Annotated[Optional[StrictStr], Field(description="Comma-separated list of mapset ids or abbreviations (or null for all mapsets). e.g. \"uuid1,uuid2\", \"SNOMEDCT_US-ICD10CM,CVX-NDC\".")] = None,
        query: Annotated[Optional[StrictStr], Field(description="Search text")] = None,
    ...
    @validate_call
    def find_project_mappings_without_preload_content(
        self,
        id_or_uri_label: Annotated[StrictStr, Field(description="Project id or uriLabel")],
        mapset: Annotated[Optional[StrictStr], Field(description="Comma-separated list of mapset ids or abbreviations (or null for all mapsets). e.g. \"uuid1,uuid2\", \"SNOMEDCT_US-ICD10CM,CVX-NDC\".")] = None,
        query: Annotated[Optional[StrictStr], Field(description="Search text")] = None,
    ...
    def _find_project_mappings_serialize(
        self,
        id_or_uri_label,
        mapset,
        query,
    ...
    @validate_call
    def find_project_mapset_mappings(
        self,
        id_or_uri_label: Annotated[StrictStr, Field(description="Project id or uriLabel")],
        mapset: Annotated[StrictStr, Field(description="Mapset id or abbreviation e.g. \"uuid1\" or \"CVX-NDC\".")],
        query: Annotated[Optional[StrictStr], Field(description="Search text")] = None,
        ...
        _param = self._find_project_mapset_mappings_serialize(
            id_or_uri_label=id_or_uri_label,
            mapset=mapset,
            query=query,
            offset=offset,
    ...
    @validate_call
    def find_project_mapset_mappings_with_http_info(
        self,
        id_or_uri_label: Annotated[StrictStr, Field(description="Project id or uriLabel")],
        mapset: Annotated[StrictStr, Field(description="Mapset id or abbreviation e.g. \"uuid1\" or \"CVX-NDC\".")],
        query: Annotated[Optional[StrictStr], Field(description="Search text")] = None,
    ...
    @validate_call
    def find_project_mapset_mappings_without_preload_content(
        self,
        id_or_uri_label: Annotated[StrictStr, Field(description="Project id or uriLabel")],
        mapset: Annotated[StrictStr, Field(description="Mapset id or abbreviation e.g. \"uuid1\" or \"CVX-NDC\".")],
        query: Annotated[Optional[StrictStr], Field(description="Search text")] = None,
    ...
    def _find_project_mapset_mappings_serialize(
        self,
        id_or_uri_label,
        mapset,
        query,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/project/{idOrUriLabel}/mapset/{mapset}/mapping',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
