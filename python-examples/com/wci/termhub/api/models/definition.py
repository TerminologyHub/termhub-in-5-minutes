...
class Definition(BaseModel):
    ...
    definition: Optional[StrictStr] = Field(default=None, description="Text of the definition")
    ...
    __properties: ClassVar[List[str]] = ["id", "confidence", "modified", "created", "modifiedBy", "local", "active", "definition", "terminology", "version", "publisher", "componentId", "localeMap", "attributes"]
