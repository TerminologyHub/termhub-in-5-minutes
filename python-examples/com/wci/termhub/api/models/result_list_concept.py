...
class ResultListConcept(BaseModel):
    ...
    items: Optional[List[Concept]] = Field(default=None, description="items of the result list")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [Concept.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
