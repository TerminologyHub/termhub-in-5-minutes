...
class ConceptApi:
    ...
    def export_concepts(
            ...
            terminology: Annotated[StrictStr, Field(
                description="Comma-separated list of terminology ids or abbreviations (or null for all terminologies). e.g. \"uuid1,uuid2\", \"SNOMEDCT,RXNORM\", or \"ICD10CM\".")],
            ...
            expression: Annotated[Optional[StrictStr], Field(
                description="ECL-style expression (<a href=\"https://github.com/terminologyhub/termhub-in-5-minutes/blob/master/doc/EXPRESSION.md\">See here for more info</a>)")] = None,
            ...
            active: Annotated[Optional[StrictBool], Field(
                description="<code>true</code> for active concepts only, <code>false</code> for inactive concepts only, <code>null</code> for both")] = None,
            leaf: Annotated[Optional[StrictBool], Field(
                description="<code>true</code> for leaf nodes only, <code>false</code> for non-leaf nodes, <code>null</code> for either")] = None,
    ...
    def export_lookup(
            ...
            terminology: Annotated[Optional[StrictStr], Field(
                description="Comma-separated list of terminology ids or abbreviations (or null for all terminologies). e.g. \"uuid1,uuid2\", \"SNOMEDCT,RXNORM\", or \"ICD10CM\".")] = None,
            expression: Annotated[Optional[StrictStr], Field(
                description="ECL-style expression (<a href=\"https://github.com/terminologyhub/termhub-in-5-minutes/blob/master/doc/EXPRESSION.md\">See here for more info</a>)")] = None,
