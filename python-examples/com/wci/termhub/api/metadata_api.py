...
from models.result_list_metadata import ResultListMetadata
...
class MetadataApi:
    ...
    def find_metadata_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ResultListMetadata]:
        """Find project terminology metadata
    ...
    def _find_metadata_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/project/{idOrUriLabel}/metadata',
    ...
    def get_terminology_metadata(
        ...
        _param = self._get_terminology_metadata_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_terminology_metadata_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Terminology id, e.g. \"uuid\"")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_terminology_metadata_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Terminology id, e.g. \"uuid\"")],
        _request_timeout: Union[
            None,
    ...
    def _get_terminology_metadata_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/terminology/{id}/metadata',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
